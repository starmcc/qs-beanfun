...
public class HttpClientImpl extends HttpClient {
    ...
    public void setCookie(Map<String, String> cookieMap) {
        ...
        for (Map.Entry<String, String> entry : cookieMap.entrySet()) {
            COOKIE_STORE.addCookie(new BasicClientCookie(entry.getKey(), entry.getValue()));
        }
    }
     ...
     * @return {@link String}
     */
    private static QsHttpResponse request(HttpClientImpl.SupplierCustom supplier) throws Exception {
        QsHttpResponse qsHttpResponse = new QsHttpResponse();

//        List<Header> headers = new ArrayList<>();
//        headers.add(new BasicHeader("Accept-Encoding", "identity"));
//        headers.add(new BasicHeader("Host", "bfweb.hk.beanfun.com"));
